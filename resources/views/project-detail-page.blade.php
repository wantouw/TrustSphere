            ...
            <div class="owner-wrapper" >
                <div class="owner-container">
                    ...
                    <div>
                        ...
                        <p class="owner-role">{{ $project->user->role->name }}</p>
                    </div>
                </div>
                @if (Auth::user()->hasRole('admin'))
                    <form class="delete-btn-container" method="POST" action="{{route('delete_project', ['project_id' => $project->id])}}">
                        @method('DELETE')
                        @csrf
                        <button type="submit">
                            <svg style="color: red !important" class="w-5 h-5 text-gray-800 dark:text-white" aria-hidden="true"
                ...
                @else
                    ...
                    <a href="https://api.whatsapp.com/send?phone={{$project->user->phone_number}}" class="whatsapp-btn">
                        Contact
                        <svg class="svgIcon" fill="#000000" height="800px" width="800px" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
